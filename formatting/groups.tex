\section{Gruppierungen}
    ...
    \subsection{Formatierung im kleinen}
        ...
        \lstinputlisting[language=Java, caption={Formatierung eines Mathematikers \autocite{benson-2022}}, label=fig:numbers]{numbers.c}
        In \ref{fig:numbers} ist beispielhaft eine für Mathematiker typische Formatierung zu erkennen.
        Alle \qq{Gruppen} einer Varriableninitialisierung stehen untereinander.
